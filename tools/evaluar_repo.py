...
def analyze_commits(root: Path) -> dict:
    ...
    for line in log:
        ...
        imperative = any(msg_lower.startswith(p) for p in ['add', 'create', 'añade', 'agrega', 'implement', 'refactor', 'remove', 'elimina', 'document', 'docs', 'feat', 'fix', 'chore'])
        score = 0
...
def main():
    ...
    readme_ok = bool(readme_text) and readme_stats['words'] >= 100 and readme_stats['headings'] >= 1
